...
Cierra con una idea que quieras dejar en tus lectores.`}</pre>
        ...
        <section className="template-guide template-faq">
          ...
          <p>
            Escríbenos a <a href={`mailto:${SITE_CONTACT.contactEmail}`}>{SITE_CONTACT.contactEmail}</a> o síguenos en{" "}
            <a href={SITE_CONTACT.instagramUrl} target="_blank" rel="noreferrer">Instagram ({SITE_CONTACT.instagramHandle})</a>.
          </p>
        </section>
      </div>
    </div>

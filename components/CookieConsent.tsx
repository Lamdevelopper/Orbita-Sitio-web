...
export function CookieConsent(){
  ...
  useEffect(()=>{const handler=()=>setOpen(true);document.querySelectorAll("[data-cookie-settings]").forEach(el=>el.addEventListener("click",handler));return()=>document.querySelectorAll("[data-cookie-settings]").forEach(el=>el.removeEventListener("click",handler));},[]);
